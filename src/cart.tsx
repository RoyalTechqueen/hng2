...
import { FaArrowLeft, FaPhoneAlt, FaApple, FaGooglePlay } from 'react-icons/fa';
...
const Cart: React.FC = () => {
  ...
  const total = cart.reduce((sum, item) => {
    const itemTotal = item.quantity * (item.current_price[0]?.NGN[0] || 0);
      ...
      <div className="container mx-auto mt-20 p-4">
        ...
        <div className="grid md:grid-cols-3 gap-4">
              ...
              cart.map((item) => (
                <div key={item.id} className="flex items-center mb-4">
                  ...
                  <div className="ml-4 flex-grow">
                    ...
                    <p className="text-sm">NGN {item.current_price[0]?.NGN[0]}</p>
          ...
          <div className="bg-white p-6">
            ...
            <button
              className="w-full bg-primary text-white p-2 mt-4 rounded"
